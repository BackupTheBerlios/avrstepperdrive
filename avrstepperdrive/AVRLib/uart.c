...
void uartInitBuffers(void)
{
		...
		bufferInit((cBuffer *)&uartRxBuffer,(unsigned char *) uartRxData, UART_RX_BUFFER_SIZE);
		// initialize the UART transmit buffer
		bufferInit((cBuffer *)&uartTxBuffer, (unsigned char *)uartTxData, UART_TX_BUFFER_SIZE);
	#else
		// initialize the UART receive buffer
